...
`github.com/lonja/goose` is a fork of `bitbucket.org/liamstask/goose` with the following changes:
- No config files
...
# Install
    ...
    $ go get -u github.com/lonja/goose/cmd/goose
...
2. Import `github.com/lonja/goose`
...
# Hybrid Versioning
Please, read the [versioning problem](https://github.com/lonja/goose/issues/63#issuecomment-428681694) first.
...
[GoDoc]: https://godoc.org/github.com/lonja/goose
[GoDoc Widget]: https://godoc.org/github.com/lonja/goose?status.svg
